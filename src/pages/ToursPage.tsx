  ...
  const tours = [
    {
      ...
      inclusions: [
        ...
        'Rencontres B2B avec 50+ fournisseurs présélectionnés',
        'Facilitation des commandes (négociation, logistique)',
        'Visite de showrooms et assistance shopping à Istanbul',
        'Achat billet d\'avion (optionnel)',
      ],
    ...
    },
    {
      ...
      inclusions: [
        ...
        '7 nuits en hôtel (petits-déjeuners inclus)',
        'Accès aux conférences et ateliers',
        'Transferts aéroport – hôtel – événements',
        'Rencontres B2B avec 50+ partenaires',
        'Facilitation des commandes',
        'Visite de showrooms à Dubai',
        'Achat billet d\'avion (optionnel)',
      ],
    ...
    },
    {
      ...
      inclusions: [
        ...
        'Accès aux conférences et ateliers',
        'Transferts aéroport – hôtel – événements',
        'Rencontres B2B avec 50+ fournisseurs',
        'Facilitation des commandes et sourcing',
        'Visite d\'usines et showrooms',
        'Achat billet d\'avion (optionnel)',
      ],
    ...
    },
    {
      ...
      inclusions: [
        ...
        'Accès aux conférences et ateliers',
        'Transferts aéroport – hôtel – événements',
        'Rencontres avec entrepreneurs locaux',
        'Visite d\'entreprises et projets',
                ...
                <div className="p-6">
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space-y-2">
                      {tour.inclusions.slice(0, 5).map((inclusion, idx) => (
                      ...
                      {tour.inclusions.length > 5 && (
                        <li className="text-sm text-pink-500 font-medium">
                          +{tour.inclusions.length - 5} autres avantages
                        </li>
                      )}
                    </ul>
                  </div>
